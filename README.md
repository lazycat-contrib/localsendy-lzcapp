...
- Received files stay inside the LazyCat application documents directory; outgoing files are read through the file chooser without being copied into application data
